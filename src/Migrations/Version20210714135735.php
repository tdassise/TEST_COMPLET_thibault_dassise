 ...
 */
final class Version20210714135735 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE pizzeria ADD pizzaiolo_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE pizzeria ADD CONSTRAINT FK_1B80AB29ADAAC69B FOREIGN KEY (pizzaiolo_id) REFERENCES pizzaiolo (id_pizzaiolo)');
        $this->addSql('CREATE INDEX IDX_1B80AB29ADAAC69B ON pizzeria (pizzaiolo_id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE pizzeria DROP FOREIGN KEY FK_1B80AB29ADAAC69B');
        $this->addSql('DROP INDEX IDX_1B80AB29ADAAC69B ON pizzeria');
        $this->addSql('ALTER TABLE pizzeria DROP pizzaiolo_id');

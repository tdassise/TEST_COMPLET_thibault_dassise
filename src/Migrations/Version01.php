...
final class Version01 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE ingredientPizza (id_ingredient_pizza INT AUTO_INCREMENT NOT NULL, ingredient_id INT DEFAULT NULL, quantite INT NOT NULL, INDEX IDX_551E6DE2933FE08C (ingredient_id), PRIMARY KEY(id_ingredient_pizza)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE ingredientPizza ADD CONSTRAINT FK_551E6DE2933FE08C FOREIGN KEY (ingredient_id) REFERENCES ingredient (id_ingredient)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE ingredientPizza DROP FOREIGN KEY FK_551E6DE2933FE08C');
        $this->addSql('ALTER TABLE pizzaiolo DROP FOREIGN KEY FK_8E1DFF22F1965E46');
        $this->addSql('DROP TABLE ingredient');
        $this->addSql('DROP TABLE ingredientPizza');
